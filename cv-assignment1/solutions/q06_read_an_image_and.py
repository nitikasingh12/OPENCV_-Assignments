...
APPROACH:
cv2.imwrite(path, img) writes the in-memory array back to disk under a new filename; the format is inferred from the file extension.
"""
...
def main():
    ...
    new_path = os.path.join(OUT_DIR, "q06_copy.png")
